  ...
  <Category title="Reasons">
    <Row elements={[
      <EditableList label="Mute" data={state.reasons.mute.map((r, i) => <>
        <Input label="Reason" value={r.reason} set={n => api.reasons.mute.setReason(i, n)} defsize p b m />
      ...
      delete={api.reasons.mute.del} column p={1} limit={5} />,
      <>
        <EditableList label="Kick" data={state.reasons.kick.map((r, i) => <>
            <Input label="Reason" value={r.reason} set={n => api.reasons.kick.setReason(i, n)} defsize p b m />
          </>)}
        ...
        <EditableList label="Ban" data={state.reasons.ban.map((r, i) => <>
            <Input label="Reason" value={r.reason} set={n => api.reasons.ban.setReason(i, n)} defsize p b m />
          ...
          delete={api.reasons.ban.del} column p={1} limit={5} />
      </>
    ]} column={layout.ap2} />
  </Category>
</>